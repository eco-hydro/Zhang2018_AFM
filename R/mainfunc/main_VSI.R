...
alpha = c(0.1, 0.05)
n <- 32
freedom <- n - 7#the number of given variables is 3
Rc = sqrt(qf(1 - alpha, 1, freedom)/(qf(1 - alpha, 1, freedom) + freedom)) %T>% print  # 0.11215
# [1] 0.3232835 0.3808629 0.4869316
brks_z <- c(qnorm(1 - alpha/2), 20)
...
get_critical <- function(alpha, freedom){
  # n <- 30
  # freedom <- n - 5#the number of given variables is 3
